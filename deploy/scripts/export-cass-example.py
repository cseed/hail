...
vds = hc.read('gs://seqr-hail/annotated/Cohen.vds')
...
# why / 5?
# removed / 8, running ~7 core Cassanrda cluster
cass_kt.export_cassandra('gke-cluster-1-default-pool-ae7776cf-kbpv', 'seqr', 'seqr', rate = 5000 / 5, port = 30001)
