...
class VariantDataset(HistoryMixin):
    ...
    def annotate_alleles_expr(self, expr):
        ...
        **Examples**
        ...
        >>> vds_result = vds.annotate_alleles_expr('va.nNonRefSamples = gs.filter(g => g.GT.isCalledNonRef()).count()')
    ...
    def annotate_variants_expr(self, expr):
        ...
        **Examples**
        ...
        >>> vds_result = vds.annotate_variants_expr('va.nonRefSamples = gs.filter(g => g.GT.isCalledNonRef()).map(g => s).collect()')
    ...
    def export_vcf(self, output, append_to_header=None, parallel=False):
        ...
        **Notes**
        ...
        The FORMAT field is generated from the genotype type, which
        :py:class:`~hail.expr.TStruct` and the exported FORMAT fields
        will be the names of each field of the Struct.
    ...
    def query_genotypes(self, exprs):
        ...
        **Examples**
        ...
        >>> call_rate = vds.query_genotypes('gs.fraction(g => g.GT.isCalled)')
    ...
    def set_va_attributes(self, ann_path, attributes):
        ...
        **Examples**
        ...
        ... 'va.info.AC_HC = gs.filter(g => g.DP >= 10 && g.GQ >= 20).map(g => g.GT).callStats(g => v).AC[1:]',
